            ...
            {isLoading ? (
                ...
                <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto ">
                    ...
                    <div className="text-2xl font-bold mb-1 flex items-center gap-2 border-y-2 py-5">
                        ...
                        <span className="text-md text-zinc-500 line-through">${product.priceAfterDiscount}</span>
                    </div>

                    {/* Color selection */}
                    {
                        product.availableColors.length > 0 && <div className="mb-4 pt-3 pb-5 border-b-2">
                    ...
                    <div className="flex space-x-4 mb-4 mt-4">
                        ...
                        <Button onClick={(e) => handleProductToWishlist(e, product?._id)}
