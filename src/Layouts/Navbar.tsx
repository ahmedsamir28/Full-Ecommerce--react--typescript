                    ...
                    <div className="dropdown dropdown-end">
                        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                            <div className="indicator">
                                ...
                                <span className="badge badge-sm indicator-item text-sm px-1.5 py-2.5 bg-zinc-300">{cartData?.numOfCartItems || 0}</span>
                            </div>
                        </div>
                        <div tabIndex={0} className="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-52 shadow">
                            <div className="card-body">
                                <span className="text-lg font-bold">{cartData?.numOfCartItems || 0} Items</span>
                                <span className="text-info">Subtotal: $ {cartData?.data.totalCartPrice || 0}</span>
